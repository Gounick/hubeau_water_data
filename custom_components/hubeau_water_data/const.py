...
THEMES: dict[str, dict] = {
        ...
        "metrics": [
            {
                "key": "1302",
                "name": "pH",
                "value_field": "resultat_numerique",
                "unit_field": "libelle_unite",
                "device_class": "ph",
                "icon": "mdi:ph",
                "filter": {"code_parametre": "1302"},
            },
            {
                "key": "1398",
                "name": "Chlore libre",
            ...
            },
            {
                ...
                "filter": {"code_parametre": "1303"},
            },
            {
                "key": "1449",
                "name": "Bactéries coliformes",
                "value_field": "resultat_numerique",
                "unit_field": "libelle_unite",
                "device_class": None,
                "icon": "mdi:bacteria",
                "filter": {"code_parametre": "1449"},
            },
            {
                "key": "1447",
                "name": "Entérocoques",
    ...
    THEME_PIEZOMETRIE: {
        ...
        "metrics": [
            {
                "key": "niveau_nappe",
                "name": "Niveau de la nappe",
                "value_field": "niveau_nappe_eau",
                "fixed_unit": "m NGF",
                "device_class": None,
                "icon": "mdi:waves-arrow-up",
                "filter": {},
            ...
            {
                "key": "profondeur_nappe",
                "name": "Profondeur de la nappe",
                "value_field": "profondeur_nappe",
                "fixed_unit": "m",
                "device_class": None,
        ...
        "metrics": [
            {
                "key": "hauteur",
                "name": "Hauteur d'eau",
                "value_field": "resultat_obs",
                "fixed_unit": "mm",
                "device_class": None,
                "icon": "mdi:waves",
                "filter": {"grandeur_hydro": "H"},
            },
            {
                "key": "debit",
                "name": "Débit",
        ...
        "metrics": [
            {
                ...
                "value_field": "resultat",
                "unit_field": "symbole_unite",
                "device_class": "temperature",
                "icon": "mdi:thermometer",
                "filter": {},
            },
    ...
    THEME_HYDROBIOLOGIE: {
        ...
        "metrics": [
            {
                "key": "ibd",
                "name": "Indice Biologique Diatomées (IBD)",
                "value_field": "resultat_indice",
                "fixed_unit": None,
                "device_class": None,
                "icon": "mdi:leaf",
            ...
            {
                "key": "ibmr",
                "name": "Indice Biologique Macrophytique (IBMR)",
                "value_field": "resultat_indice",
                "fixed_unit": None,
                "device_class": None,
                "icon": "mdi:flower",
                "filter": {"libelle_indice": "IBMR"},
            },
        ],
    },
    THEME_PRELEVEMENTS: {
    ...
    THEME_INDICATEURS_SERVICES: {
        ...
        "metrics": [
            {
                "key": "prix_eau",
                "name": "Prix du service d'eau potable",
                "value_field": "valeur_indicateur_min",
                "fixed_unit": "€/m³",
                "device_class": "monetary",
                "icon": "mdi:cash",
                "filter": {"code_indicateur": "D102.0", "type_service": "AEP"},
            },
            {
                "key": "rendement_reseau",
                "name": "Rendement du réseau de distribution",
                "value_field": "valeur_indicateur_min",
                "fixed_unit": "%",
                "device_class": None,
                "icon": "mdi:pipe-leak",
                "filter": {"code_indicateur": "P104.3", "type_service": "AEP"},
            },
            {
                "key": "taux_conformite",
                "name": "Taux de conformité du contrôle sanitaire",
                "value_field": "valeur_indicateur_min",
                "fixed_unit": "%",
                "device_class": None,
                "icon": "mdi:check-decagram",
                "filter": {"code_indicateur": "P101.1", "type_service": "AEP"},
            },
        ],
    },
    THEME_ECOULEMENT: {
        ...
        "metrics": [
            {
                "key": "ecoulement",
                "name": "Écoulement visuel du cours d'eau",
                "value_field": "libelle_ecoulement",
                "fixed_unit": None,
                "device_class": None,
                "icon": "mdi:waves",
                "filter": {},
    ...
    THEME_LITTORAL: {
        ...
        "metrics": [
            {
                "key": "contaminant",
                "name": "Dernier contaminant chimique analysé",
                "value_field": "resultat_analyse",
                "unit_field": "libelle_unite_resultat",
                "device_class": None,
                "icon": "mdi:flask-outline",
                "filter": {},
            },
    ...
    THEME_POISSON: {
        ...
        "metrics": [
            {
                "key": "derniere_espece",
                "name": "Dernière espèce observée",
                "value_field": "nom_commun_taxon",
                "fixed_unit": None,
                "device_class": None,
                "icon": "mdi:fish",
                "filter": {},
    ...
    THEME_PHYTOPHARMACEUTIQUES: {
        ...
        "metrics": [
            {
                "key": "ventes_substances",
                "name": "Quantité de substances vendues (dernière année)",
                "value_field": "quantite_substance",
                "fixed_unit": "kg",
                "device_class": None,
                "icon": "mdi:spray-bottle",
                "filter": {"type_territoire": "Département"},
            },
        ],
    },
}
